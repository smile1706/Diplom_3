...
class OrdersPageLocators:
    ORDERS_ALL_TIME_COUNTER = (By.XPATH,"//p[@class='text text_type_main-medium'][text()='Выполнено за все время:']/following-sibling::p[1]")
    ORDERS_TODAY_COUNTER = (By.XPATH,"//p[@class='text text_type_main-medium'][text()='Выполнено за сегодня:']/following-sibling::p[1]")
