...
class MainPageLocators:
    ORDER_LIST_BUTTON_HEADER = (By.XPATH, "//a[@class='AppHeader_header__link__3D_hX'][@href='/feed']")
    INGREDIENT_NAME_POPUP = (By.XPATH, "//p[@class='text text_type_main-medium mb-8']")
    INGREDIENT_DETAILS_POPUP_CLOSE_BUTTON = (By.XPATH, "//section[@class='Modal_modal_opened__3ISw4 Modal_modal__P3_V5']/div/button[@class='Modal_modal__close_modified__3V5XS Modal_modal__close__TnseK']")
    ...
    def ingredient_number(path_index,ingredient_index):
        return By.XPATH, f"//h2[@class='text text_type_main-medium mb-6 mt-10'][contains(text(),'Булки')]/following-sibling::ul[{path_index}]/a[@class='BurgerIngredient_ingredient__1TVf6 ml-4 mr-4 mb-8'][{ingredient_index}]",
